...
function getArtistByIndex(list, index) {
  return "the artist at index " + index + " is " + list[index].name;
}
...
for (let i = 0; i < list.length; i++) {
  let characters = list[i].years.split(" ");
  if (characters[0] > 1899 && characters[2] < 2001) {
...
function addArtist(list, object) {
  list.push(object);
  return  list;
}
